...
# 24/06 class NumbersRegistersAdmin(admin.ModelAdmin):
#     list_display = ('number_register','function_first','function_second','section') # lista os prdoutos no ADM em formato de tabela com essas colunas

class NumbersRegistersAdmin(admin.ModelAdmin):
    list_display = ('number_register','name', 'section','email','phone','created_at','updated_at') # lista os prdoutos no ADM em formato de tabela com essas colunas
