...
class NrRegisterForm(forms.Form):
    help_text_registro ='Digite o número do registro'
    nr = forms.CharField(label='', max_length=20, help_text=help_text_registro, empty_value='')
    

class AssociateDataModelForm(forms.ModelForm):
    class Meta:
        model = AssociateData
        fields = ['name','phone','email','accept_1','accept_2','accept_3']
    #number_register = forms.CharField(label='Número de Registro', max_length=20) 'responsible_1'
    name = forms.CharField(label='Nome do Escotista', max_length=100)
    # responsible_1 = forms.CharField(label='Nome do Responsável 1,'responsible_2'', max_length=100, min_length=0)
...
class SearchForm(forms.Form):
    ...
    text_search = forms.CharField(label='', max_length=100, min_length=0, help_text=help_text, empty_value='')
